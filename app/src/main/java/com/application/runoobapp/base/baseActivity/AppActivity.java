...
import com.application.runoobapp.base.action.TitleBarAction;
import com.application.runoobapp.base.action.ToastAction;
import com.application.runoobapp.base.dialog.BaseDialog;
import com.application.runoobapp.base.dialog.WaitDialog;
...
/**
 * activity 业务基类
 * TODO: 这里toaster、easyHttp是通过本地aar加载进来的，后续研究下gradle7.0怎么配置
 */
