package com.application.runoobapp.base.dialog;
...
import com.application.runoobapp.base.action.AnimAction;
...
import com.application.runoobapp.base.action.ResourceAction;
...
public class BaseDialog extends AppCompatDialog implements LifecycleOwner,
        ActivityAction, ResourceAction, HandlerAction, ClickAction, AnimAction,
        KeyboardAction, DialogInterface.OnShowListener, DialogInterface.OnCancelListener,
    ...
    public static class Builder<B extends BaseDialog.Builder<?>> implements
            ActivityAction, ResourceAction, ClickAction, KeyboardAction {
